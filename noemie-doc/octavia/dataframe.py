...
def auto() : #100 lignes de barres qui sont toujours differentes
     ...
     # determine les choix de colnonne des complice
     cols = ["1","2","3"]
     # on met dans finalChoices le choix final 
     finalChoices = []
     # pour chaqye ligne dans df
     for l in range(len(df)):
         # on prend la valeur de ref pas ref directement
         ref_val = df.loc[l, "ref"]
            # on determine les choix possibles parmis les colonne qui ne sont pas egale a ref
